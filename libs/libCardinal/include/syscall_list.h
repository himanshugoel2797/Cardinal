...
typedef enum {
    ...
    // TODO: setup tag-object location database in kernel
    // TODO: provide syscalls for database operations
    // TODO: provide R1 syscalls for registering database providers and object
    // stores.
    ...
    Syscall_RegisterTagProvider,
    Syscall_RemoveTagProvider,
    Syscall_GetTagList,
    Syscall_GetWithTag,
    Syscall_Read,
    Syscall_Write,
    Syscall_ObjectIoctl,
    Syscall_RemoveObjectTag,
