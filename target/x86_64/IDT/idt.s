...
.Ltmp5:
	...
	movl	%ecx, %esi
	shlq	$4, %rsi
	movw	%r10w, idt_entries(%rsi)
	movw	-14(%rbp), %r10w
	movzbl	-1(%rbp), %ecx
	movl	%ecx, %esi
	shlq	$4, %rsi
	movw	%r10w, idt_entries+6(%rsi)
	movl	-12(%rbp), %ecx
	movzbl	-1(%rbp), %edx
	movl	%edx, %esi
	shlq	$4, %rsi
...
.Lfunc_end2:
	...
	.globl	IDT_ChangeEntry
	.align	16, 0x90
	.type	IDT_ChangeEntry,@function
IDT_ChangeEntry:                        # @IDT_ChangeEntry
	.cfi_startproc
# BB#0:
	pushq	%rbp
.Ltmp10:
...
.Ltmp12:
	...
	movl	%ecx, %r11d
	shlq	$4, %r11
	movb	%al, idt_entries+4(%r11)
	movzwl	-4(%rbp), %ecx
	movw	%cx, %r9w
	movzbl	-1(%rbp), %ecx
	movl	%ecx, %r11d
	shlq	$4, %r11
	leaq	idt_entries(%r11), %r11
	movw	%r9w, 2(%r11)
	addq	$6, %rsp
	popq	%rbp
	retq
.Lfunc_end3:
	.size	IDT_ChangeEntry, .Lfunc_end3-IDT_ChangeEntry
	.cfi_endproc
...
# BB#0:
	...
	#NO_APP
.Lfunc_end4:
	.size	IDT_DefaultHandler, .Lfunc_end4-IDT_DefaultHandler
	.cfi_endproc
...
.Ltmp15:
	...
	movq	%rdi, -8(%rbp)
	movq	120(%rdi), %rdi
	leaq	idt_handler_calls(,%rdi,8), %rdi
	cmpq	$0, (%rdi)
	je	.LBB5_2
# BB#1:
	movq	-8(%rbp), %rax
...
.LBB5_2:
	...
	retq
.Lfunc_end5:
	.size	IDT_MainHandler, .Lfunc_end5-IDT_MainHandler
	.cfi_endproc
...
.Ltmp18:
	...
	retq
.Lfunc_end6:
	.size	IDT_RegisterHandler, .Lfunc_end6-IDT_RegisterHandler
	.cfi_endproc
